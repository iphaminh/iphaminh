...
- **Watch Tuesday's sync run (Aug 25, 23:00 UTC):** first live run with both guards — expect the log to show "⛔ Skipping 14" (couple dupes), "🚫 Skipping 3" (non-wedding), and one clean wedding upload.
