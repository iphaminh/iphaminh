...
- **Design evolution queue** (screenshot-by-screenshot loop is working): next candidates — dark-gold film gallery cards, unified press/award bar. Playwright screenshots work in the cloud sandbox: serve build/ w/ python http.server + playwright-core + /opt/pw-browsers/chromium.
