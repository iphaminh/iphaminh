...
- **Design evolution queue** (Minh wants "luxury rebuild", agreed to iterate screenshot-by-screenshot): next candidates — unified press/award bar, dark-gold film gallery cards, editorial /pricing.
